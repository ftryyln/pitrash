...
TextStyle aqafe = GoogleFonts.sacramento(color: whiteColor, fontSize: 48);

TextStyle title = GoogleFonts.beVietnamPro(
    color: whiteColor, fontSize: 24, fontWeight: semiBold);

TextStyle titleArticle = GoogleFonts.museoModerno(
    color: whiteColor,
    fontSize: 20,
    fontWeight: semiBold,
    shadows: <Shadow>[
